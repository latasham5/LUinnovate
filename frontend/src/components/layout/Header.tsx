      ...
      <div className="flex items-center gap-3">
        ...
        {user && (
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 hover:bg-red-50 hover:border-red-200 transition-colors"
            aria-label="Sign out"
          >
            <LogOut className="w-4 h-4 text-gray-500 hover:text-red-500" aria-hidden="true" />
          </button>
        )}
      </div>
    </header>
